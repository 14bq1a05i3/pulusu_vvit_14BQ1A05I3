...
# current_date_value = date.today() #'2022-01-25' Need to pass as Parameter from AHOLD Item Master

# loggerAtt.info("The date in weeklyAd is: "+ current_date_value)

# def currentDateValue(val):
#   return current_date_value
# setCurrentDateValueUDF = udf(currentDateValue)
...
### Option 2: Get the date for which itemMaster notebook  is running.
...
# MAGIC and df4.PRD2STORE_BANNER_ID Like "%AHOLD%" --- Coulmn check with Business team
# MAGIC WHEN MATCHED 
...
# MAGIC %sql SELECT * FROM default.itemmasterAhold where DEMANDTEC_PRISM_SID is not Null
