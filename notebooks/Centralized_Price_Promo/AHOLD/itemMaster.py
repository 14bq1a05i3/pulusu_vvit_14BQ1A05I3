...
#   #WeeklyAD Notebook Execution 01/25/2022
#   dbutils.notebook.run('ItemMaster_WeeklyAD', 12000)
  
#   args = json.dumps({"current_date_value": currentDate})
...
#     loggerAtt.info(args)
    ...
    dbutils.notebook.run("/Centralized_Price_Promo/AHOLD/ItemMaster_WeeklyAD", 12000, {"current_date_value": currentDate})
