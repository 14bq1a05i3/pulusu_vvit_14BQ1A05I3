  ...
  try:
    ...
    WHEN MATCHED Then 
            Update Set  itemMaster.SMA_ACTIVATION_CODE = unified_df.SMA_ACTIVATION_CODE,
                        ...
                        itemMaster.SALE_PRICE = (CASE WHEN ((unified_df.SALE_PRICE = '0000000.00' or unified_df.SALE_PRICE = 0.00) or unified_df.SALE_PRICE is Null)
                                                      then NULL
                                                      else COALESCE(unified_df.SALE_PRICE, itemMaster.SALE_PRICE)
                                                 END ) ,
                        itemMaster.SALE_QUANTITY = (CASE WHEN ((unified_df.SALE_QUANTITY = '0'  or unified_df.SALE_QUANTITY = 0) or unified_df.SALE_QUANTITY is Null)
                                                         then NULL
...
def updatePromoRecords(unifiedPromoLinkDf, itemMasterDeltaPath):
  ...
  try:
    ...
    WHEN MATCHED Then 
            Update Set  
                        itemMaster.SALE_PRICE = unifiedPromoLinkDf.SALE_PRICE,
